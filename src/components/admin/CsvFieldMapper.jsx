...
const ENTITY_FIELDS = [
  ...
  { value: 'stock_quantity', label: 'Quantité en stock', required: false },
  ...
  { value: 'tax_class', label: 'Classe de TVA', required: false },
  { value: 'shipping_class', label: 'Classe d\'expédition', required: false },
