...
const DEFAULT_MAPPING = {
  ...
  'Obédiences': 'rite_hint',
  'Nom du produit': 'name',
  'Référence du produit': 'sku',
  'Images du produit ( à importer )': 'images',
  'Taille': 'sizes',
  ...
  'Autoriser les commandes de produits en rupture ?': 'allow_backorders',
  'Vendre individuellement ?': 'sold_individually',
  'Poids (kg)': 'weight',
  'Longueur (cm)': 'length',
  'Largeur (cm)': 'width',
  'Hauteur (cm)': 'height',
  'Autoriser les avis clients ?': 'enable_reviews',
